...
Future<RecipeFolder> _$RecipeFolderFromSupabase(
...
Future<Map<String, dynamic>> _$RecipeFolderToSupabase(
  RecipeFolder instance, {
  required SupabaseProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
  return {
...
Future<RecipeFolder> _$RecipeFolderFromSqlite(
  Map<String, dynamic> data, {
...
Future<Map<String, dynamic>> _$RecipeFolderToSqlite(
  RecipeFolder instance, {
  required SqliteProvider provider,
  OfflineFirstWithSupabaseRepository? repository,
}) async {
...
class RecipeFolderAdapter
  ...
  Future<int?> primaryKeyByUniqueColumns(
    ...
    final results = await executor.rawQuery(
      '''
        SELECT * FROM `RecipeFolder` WHERE id = ? LIMIT 1''',
      [instance.id],
    );
  ...
  @override
  Future<RecipeFolder> fromSupabase(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$RecipeFolderFromSupabase(
    input,
    provider: provider,
  ...
  Future<Map<String, dynamic>> toSupabase(
    ...
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$RecipeFolderToSupabase(
    input,
    provider: provider,
    repository: repository,
  );
  @override
  Future<RecipeFolder> fromSqlite(
    Map<String, dynamic> input, {
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$RecipeFolderFromSqlite(
    input,
    provider: provider,
    repository: repository,
  );
  ...
  Future<Map<String, dynamic>> toSqlite(
    ...
    required provider,
    covariant OfflineFirstWithSupabaseRepository? repository,
  }) async => await _$RecipeFolderToSqlite(
    input,
    provider: provider,
    repository: repository,
  );
