...
Future<RecipeImage> _$RecipeImageFromSupabase(Map<String, dynamic> data,
...
Future<Map<String, dynamic>> _$RecipeImageToSupabase(RecipeImage instance,
    {required SupabaseProvider provider,
    OfflineFirstWithSupabaseRepository? repository}) async {
  return {
...
Future<RecipeImage> _$RecipeImageFromSqlite(Map<String, dynamic> data,
...
Future<Map<String, dynamic>> _$RecipeImageToSqlite(RecipeImage instance,
    {required SqliteProvider provider,
    OfflineFirstWithSupabaseRepository? repository}) async {
  return {
...
class RecipeImageAdapter extends OfflineFirstWithSupabaseAdapter<RecipeImage> {
  ...
  Future<int?> primaryKeyByUniqueColumns(
      RecipeImage instance, DatabaseExecutor executor) async {
    final results = await executor.rawQuery('''
        SELECT * FROM `RecipeImage` WHERE id = ? LIMIT 1''', [instance.id]);
  ...
  @override
  Future<RecipeImage> fromSupabase(Map<String, dynamic> input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$RecipeImageFromSupabase(input,
          provider: provider, repository: repository);
  @override
  Future<Map<String, dynamic>> toSupabase(RecipeImage input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$RecipeImageToSupabase(input,
          provider: provider, repository: repository);
  @override
  Future<RecipeImage> fromSqlite(Map<String, dynamic> input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$RecipeImageFromSqlite(input,
          provider: provider, repository: repository);
  @override
  Future<Map<String, dynamic>> toSqlite(RecipeImage input,
          {required provider,
          covariant OfflineFirstWithSupabaseRepository? repository}) async =>
      await _$RecipeImageToSqlite(input,
          provider: provider, repository: repository);
}
