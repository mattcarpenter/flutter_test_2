...
class $RecipeTagsTable extends RecipeTags
    with TableInfo<$RecipeTagsTable, RecipeTagEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<String> color = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant('#4285F4'));
  static const VerificationMeta _userIdMeta = const VerificationMeta('userId');
  @override
  late final GeneratedColumn<String> userId = GeneratedColumn<String>(
      'user_id', aliasedName, true,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, color, userId, householdId, createdAt, updatedAt, deletedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  VerificationContext validateIntegrity(Insertable<RecipeTagEntry> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => const {};
  @override
  RecipeTagEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
...
class RecipeTagEntry extends DataClass implements Insertable<RecipeTagEntry> {
  final String id;
  final String name;
  final String color;
  final String? userId;
  ...
  factory RecipeTagEntry.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return RecipeTagEntry(
      id: serializer.fromJson<String>(json['id']),
  ...
  RecipeTagEntry copyWithCompanion(RecipeTagsCompanion data) {
    return RecipeTagEntry(
      id: data.id.present ? data.id.value : this.id,
      name: data.name.present ? data.name.value : this.name,
  ...
  @override
  String toString() {
    return (StringBuffer('RecipeTagEntry(')
          ..write('id: $id, ')
          ..write('name: $name, ')
          ..write('color: $color, ')
          ..write('userId: $userId, ')
...
class RecipeTagsCompanion extends UpdateCompanion<RecipeTagEntry> {
  final Value<String> id;
  final Value<String> name;
  ...
  static Insertable<RecipeTagEntry> custom({
    Expression<String>? id,
    Expression<String>? name,
...
class $RecipesTable extends Recipes with TableInfo<$RecipesTable, RecipeEntry> {
  ...
  late final GeneratedColumnWithTypeConverter<List<String>?, String> tagIds =
      GeneratedColumn<String>('tag_ids', aliasedName, true,
              type: DriftSqlType.string, requiredDuringInsert: false)
          .withConverter<List<String>?>($RecipesTable.$convertertagIdsn);
  @override
  ...
  RecipeEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RecipeEntry(
      ...
      tagIds: $RecipesTable.$convertertagIdsn.fromSql(attachedDatabase
          .typeMapping
  ...
  static TypeConverter<List<String>, String> $convertertagIds =
      StringListTypeConverter();
  static TypeConverter<List<String>?, String?> $convertertagIdsn =
...
class RecipeEntry extends DataClass implements Insertable<RecipeEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || tagIds != null) {
      map['tag_ids'] =
          Variable<String>($RecipesTable.$convertertagIdsn.toSql(tagIds));
    }
...
class RecipesCompanion extends UpdateCompanion<RecipeEntry> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (tagIds.present) {
      map['tag_ids'] =
          Variable<String>($RecipesTable.$convertertagIdsn.toSql(tagIds.value));
    }
    if (images.present) {
      map['images'] =
...
class $ClippingsTable extends Clippings
    with TableInfo<$ClippingsTable, ClippingEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ClippingsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'clippings';
  @override
  VerificationContext validateIntegrity(Insertable<ClippingEntry> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  ClippingEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $ClippingsTable createAlias(String alias) {
    return $ClippingsTable(attachedDatabase, alias);
  }
}

class ClippingEntry extends DataClass implements Insertable<ClippingEntry> {
  final String id;
  final String? title;
  ...
  ClippingsCompanion toCompanion(bool nullToAbsent) {
    return ClippingsCompanion(
      id: Value(id),
      title:
  ...
  factory ClippingEntry.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ClippingEntry(
      id: serializer.fromJson<String>(json['id']),
  ...
  ClippingEntry copyWithCompanion(ClippingsCompanion data) {
    return ClippingEntry(
      id: data.id.present ? data.id.value : this.id,
      title: data.title.present ? data.title.value : this.title,
  ...
  @override
  String toString() {
    return (StringBuffer('ClippingEntry(')
          ..write('id: $id, ')
          ..write('title: $title, ')
  ...
  @override
  int get hashCode => Object.hash(
      id, title, content, userId, householdId, createdAt, updatedAt, deletedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is ClippingEntry &&
          other.id == this.id &&
          other.title == this.title &&
...
class ClippingsCompanion extends UpdateCompanion<ClippingEntry> {
  final Value<String> id;
  final Value<String?> title;
  ...
  static Insertable<ClippingEntry> custom({
    Expression<String>? id,
    Expression<String>? title,
  ...
  @override
  String toString() {
    return (StringBuffer('ClippingsCompanion(')
          ..write('id: $id, ')
          ..write('title: $title, ')
          ..write('content: $content, ')
          ..write('userId: $userId, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $ClippingsTable clippings = $ClippingsTable(this);
  @override
...
class $$RecipeTagsTableTableManager extends RootTableManager<
    ...
    (
      RecipeTagEntry,
      BaseReferences<_$AppDatabase, $RecipeTagsTable, RecipeTagEntry>
    ),
    RecipeTagEntry,
    PrefetchHooks Function()> {
...
typedef $$TimersTableProcessedTableManager = ProcessedTableManager<
    ...
    TimerEntry,
    PrefetchHooks Function()>;
typedef $$ClippingsTableCreateCompanionBuilder = ClippingsCompanion Function({
  Value<String> id,
  Value<String?> title,
  Value<String?> content,
  Value<String?> userId,
...
typedef $$ClippingsTableUpdateCompanionBuilder = ClippingsCompanion Function({
  Value<String> id,
  Value<String?> title,
  Value<String?> content,
  Value<String?> userId,
...
class $$ClippingsTableFilterComposer
    extends Composer<_$AppDatabase, $ClippingsTable> {
  $$ClippingsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ClippingsTableOrderingComposer
    extends Composer<_$AppDatabase, $ClippingsTable> {
  $$ClippingsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ClippingsTableAnnotationComposer
    extends Composer<_$AppDatabase, $ClippingsTable> {
  $$ClippingsTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$ClippingsTableTableManager extends RootTableManager<
    _$AppDatabase,
    $ClippingsTable,
    ClippingEntry,
    $$ClippingsTableFilterComposer,
    $$ClippingsTableOrderingComposer,
    $$ClippingsTableAnnotationComposer,
    $$ClippingsTableCreateCompanionBuilder,
    $$ClippingsTableUpdateCompanionBuilder,
    (
      ClippingEntry,
      BaseReferences<_$AppDatabase, $ClippingsTable, ClippingEntry>
    ),
    ClippingEntry,
    PrefetchHooks Function()> {
  $$ClippingsTableTableManager(_$AppDatabase db, $ClippingsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$ClippingsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$ClippingsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$ClippingsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String?> title = const Value.absent(),
            Value<String?> content = const Value.absent(),
...
typedef $$ClippingsTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $ClippingsTable,
    ClippingEntry,
    $$ClippingsTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$ClippingsTableTableManager get clippings =>
      $$ClippingsTableTableManager(_db, _db.clippings);
}
