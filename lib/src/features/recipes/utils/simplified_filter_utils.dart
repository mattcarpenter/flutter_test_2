...
import 'package:recipe_app/src/providers/unified_filter_sort_provider.dart';

/// Simplified utility class for filtering and sorting recipes
class SimplifiedFilterUtils {
  ...
  /// Simplified function to ensure pantry match data is loaded when needed
