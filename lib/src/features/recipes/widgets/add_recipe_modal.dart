...
class _AddRecipeContentState extends ConsumerState<_AddRecipeContent> {
  ...
  Widget build(BuildContext context) {
    ...
    // Available height for scrollable content (subtract keyboard when visible)
    final scrollableHeight = (maxContentHeight - searchFieldHeight - keyboardHeight).clamp(100.0, double.infinity);
